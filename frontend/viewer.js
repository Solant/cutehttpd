...
function showImage(b, fileName) {
    ...
    loadImageList();
    document.getElementById("viewer_counter").textContent = (imageList.indexOf(fileName)+1) +  "/" + imageList.length;
...
function showNextImage() {
    ...
    document.getElementById("viewer_counter").textContent = (nextIndex + 1) +  "/" + imageList.length;
}
